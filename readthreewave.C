...
int main()
{
  ...
  const char command_setsource[] = ":WAVeform:SOURce CHANnel4"; /// Set wave source
  ...
  // Initial  LXI device
  lxi_init();
  device = lxi_connect("192.168.21.121", 0, "inst0", timeout, VXI11);
  ...
  graph2->SetTitle("Oscilloscope Waveform;Time (s);Voltage (V)");
  ...
  graph3->SetTitle("Oscilloscope Waveform;Time (s);Voltage (V)");
